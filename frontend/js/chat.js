...
class DeksChat {
    ...
    initializeElements() {
        ...
        this.chatSuggestions = document.querySelectorAll('.chat-suggestion');
    }
    ...
    bindEvents() {
        ...
        // 추천 메시지 클릭
        this.chatSuggestions.forEach(suggestion => {
    ...
    toggleChat() {
        ...
        this.chatContent.style.display = isVisible ? 'none' : 'flex';
        
        const icon = this.toggleChatBtn.querySelector('i');
        icon.className = isVisible ? 'fas fa-comments' : 'fas fa-comments';
